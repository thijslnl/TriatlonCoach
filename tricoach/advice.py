...
INSIGHTS_SYSTEM = (
    ...
    "SWOLF — die geldt alleen over crawlbanen in het 25m-bad; benoem dat "
    "filter als je er iets over zegt), is de belastingsopbouw gezond? "
    "Schrijf in het Nederlands 3 tot 6 "
