...
SYSTEM = (
    ...
    "Kickr-trainer binnen): VERMOGEN is dan de primaire intensiteitsmaat; "
    "hartslag blijft de secundaire check. HR reageert traag en wordt "
    ...
    "- Zwemmen: GÉÉN zone 2-verwachting en geen afrekening op hartslagzones. "
    "De atleet leert nog volop techniek; de hartslag zegt daar meer over "
